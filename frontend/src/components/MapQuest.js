...
//                         // Add markers for canyons
//                         console.log(canyons)
//                         canyons.forEach(canyon => {
//                             if (canyon.latitude && canyon.longitude) {
//                                 // let marker = window.L.marker([canyon.latitude, canyon.longitude], {
//                                 //     icon: window.L.mapquest.icons.marker(),
//                                 //     draggable: false
//                                 //     }).addTo(map.current);
//                                 let marker = window.L.marker([canyon.latitude, canyon.longitude]).addTo(map.current);
